...
Can optionally use Hugging Face API token for better model access.
"""
import logging
import numpy as np
import os
...
class EmbeddingService:
    ...
    def __init__(self, model_name: str = "all-MiniLM-L6-v2", hf_token: str = None):
        ...
        Args:
            ...
            hf_token: Hugging Face API token (optional, falls back to env var HF_TOKEN)
        """
...
if __name__ == "__main__":
    ...
    test_text = "This is a test document about engineering setup."
